    ...
    <main className="pt-16">
      ...
      <RelatedLinks
        ...
        items={[
          ...
          { href: "/locations/gbp-optimization-lakeland", label: "GBP Optimization in Lakeland", description: "Business Profile optimization for practices in Lakeland and Polk County." },
        ]}
      />
