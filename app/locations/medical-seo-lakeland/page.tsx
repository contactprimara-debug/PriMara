...
const PAGE_URL = `${SITE_URL}/locations/medical-seo-lakeland`;

export const metadata: Metadata = {
  title: "Medical SEO in Lakeland, FL | Primara",
  description:
    "Medical SEO for independent practices in Lakeland and Polk County — Google Business Profile, local rankings, on-page and technical SEO from a Florida medical marketing agency. Call (561) 291-2681.",
  alternates: { canonical: PAGE_URL },
  robots: { index: true, follow: true },
  openGraph: {
    title: "Medical SEO in Lakeland, FL | Primara",
    description:
      "Medical SEO for independent practices in Lakeland and Polk County — GBP optimization, local rankings, on-page and technical SEO from a Florida agency.",
    type: "website",
    url: PAGE_URL,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Medical SEO Lakeland", item: PAGE_URL },
  ],
};
...
const serviceSchema = {
  ...
  description:
    "Local and organic SEO for independent medical practices in Lakeland, Florida — Google Business Profile optimization, on-page optimization, technical SEO, and content strategy across Polk County.",
};

const faqs = [
  {
    q: "Do you work with medical practices in Lakeland?",
    a: "Yes. Primara is a Florida-based medical marketing agency — headquartered in West Palm Beach — and Lakeland is a market we actively serve. We work with independent practices nationwide, and the entire service is delivered remotely: rank grids, Google Business Profile management, and monthly reporting work exactly the same whether your practice is on South Florida Avenue or in North Lakeland.",
  },
  {
    q: "What does medical SEO include for a Lakeland practice?",
    a: "The same full stack we run everywhere: complete Google Business Profile configuration, local rank tracking across your real Polk County service area, on-page optimization (titles, headings, schema markup, internal linking), technical SEO fixes, and content built around the searches Lakeland patients actually make.",
  },
  {
    q: "What makes Lakeland different from other Florida markets?",
    a: "Lakeland sits on the I-4 corridor between Tampa and Orlando, and it's one of the fastest-growing metro areas in Florida. New residents arrive without an established doctor and start with a Google search. Large regional health systems dominate those results by default — but that also means an independent practice with a properly optimized presence can stand out quickly.",
  },
  {
    q: "How long until a Lakeland practice sees SEO results?",
...
const deliverables = [
  {
    ...
    body: "For a Lakeland practice, the Maps pack is the front door. We configure categories, services, attributes, and a posting cadence so your listing competes with the large health-system clinics that dominate Polk County results by default.",
  },
  {
  ...
  },
  {
    ...
    body: "Patients in Lakeland search by condition, insurance, and neighborhood — not by your practice name. We build service and location pages that meet those searches, grounded in what your practice actually offers.",
  },
  {
    title: "Transparent Monthly Reporting",
    body: "Rank tracking across your Polk County service area plus Google Search Console and GA4 data every month. You see exactly which keywords moved and what we did — no vanity metrics.",
  },
];

export default function MedicalSeoLakelandPage() {
  return (
    <main className="pt-16">
      ...
      <nav aria-label="Breadcrumb" style={{ backgroundColor: "var(--surface)", borderBottom: "1px solid var(--wire)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8 py-3">
          <ol className="flex items-center gap-2 flex-wrap" style={{ color: "var(--smoke)", fontSize: "0.8125rem" }}>
            ...
            <li aria-hidden="true" style={{ color: "var(--wire)" }}>/</li>
            <li style={{ color: "var(--chalk)" }}>Medical SEO Lakeland</li>
          </ol>
        </div>
      </nav>
      ...
      <section style={{ backgroundColor: "var(--void)", padding: "clamp(56px, 8vw, 96px) 0 clamp(40px, 6vw, 72px)", borderBottom: "1px solid var(--wire)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8">
          ...
          >
            Medical SEO in Lakeland
          </h1>
          <p style={{ fontSize: "1.0625rem", color: "var(--ash)", lineHeight: 1.75, maxWidth: "640px", marginBottom: "40px" }}>
            Primara is a Florida medical marketing agency built for independent
            ...
            searching in Lakeland and across Polk County find your practice instead of
            the big health systems.
          </p>
          ...
          <p style={{ marginTop: "20px", fontSize: "0.8125rem", color: "var(--smoke)" }}>
            Liam Costello &amp; Gio LaRoche, Co-Founders · Florida-based · No long-term contracts
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-content px-6 lg:px-8">
          <div style={{ maxWidth: "760px" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 400, color: "var(--chalk)", lineHeight: 1.2, marginBottom: "24px" }}>
              Lakeland is growing fast — and new patients start with Google.
            </h2>
            <p style={{ fontSize: "1rem", color: "var(--ash)", lineHeight: 1.8, marginBottom: "20px" }}>
              Lakeland sits on the I-4 corridor between Tampa and Orlando, and Polk County
              keeps adding residents who arrive without an established doctor. When someone
              new to Lakeland searches &ldquo;primary care doctor near me&rdquo; or
              &ldquo;therapist accepting new patients,&rdquo; Google decides in real time
              which practices appear — based on the strength of the Google Business
              Profile, the relevance of the website, and the consistency of the
              practice&rsquo;s information online. Independent practices lose that contest
              by default, because the large regional health systems here have dedicated
      ...
      <RelatedLinks
        ...
        items={[
          ...
          { href: "/locations/google-ads-management-lakeland", label: "Google Ads Management in Lakeland", description: "The paid side — search campaigns and Local Service Ads for Lakeland practices." },
          { href: "/locations/gbp-optimization-lakeland", label: "GBP Optimization in Lakeland", description: "Business Profile optimization for practices competing in the Lakeland Maps pack." },
          { href: "/locations/lakeland-fl", label: "Primary Care Marketing — Lakeland", description: "Our full marketing service for Lakeland primary care practices." },
      ...
      <section style={{ backgroundColor: "var(--color-primary)", borderTop: "3px solid var(--ember)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8 py-16 text-center">
          <h2 style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 400, color: "var(--chalk)", marginBottom: "1rem" }}>
            Ready to Get Found in Lakeland?
          </h2>
