...
const PAGE_URL = `${SITE_URL}/locations/gbp-optimization-lakeland`;

export const metadata: Metadata = {
  title: "GBP Optimization in Lakeland, FL | Primara",
  description:
    "Google Business Profile optimization for independent medical practices in Lakeland and Polk County — categories, posting cadence, and Maps-pack visibility from a Florida agency. Call (561) 291-2681.",
  alternates: { canonical: PAGE_URL },
  robots: { index: true, follow: true },
  openGraph: {
    title: "GBP Optimization in Lakeland, FL | Primara",
    description:
      "Google Business Profile optimization and management for independent medical practices in Lakeland — categories, posting cadence, photos, and Maps-pack visibility.",
    type: "website",
    url: PAGE_URL,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "GBP Optimization Lakeland", item: PAGE_URL },
  ],
};
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "GBP Optimization in Lakeland",
  url: PAGE_URL,
  provider: {
    "@type": "LocalBusiness",
    name: "Primara",
  ...
  description:
    "Google Business Profile optimization and management for independent medical practices in Lakeland, Florida — categories, services, attributes, posting cadence, photo strategy, and Maps-pack visibility across Polk County.",
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "Local visibility usually moves faster than organic SEO — typically within 60–90 days. We track it with rank grids across your real Polk County service area, so you can see exactly where your profile shows up across Lakeland, not just from one spot.",
  },
];
...
const deliverables = [
  {
    ...
    body: "Primary and secondary categories chosen deliberately, the full services list built out, attributes set, hours accurate (including holidays), and a business description written for what Lakeland patients actually search.",
  },
  {
  ...
  },
  {
    ...
    body: "We track your Maps visibility on a geographic grid across your real Polk County service area — not a single ranking number from one location — so you see exactly which neighborhoods you're winning and where the gaps are.",
  },
  {
...
export default function GbpOptimizationLakelandPage() {
  return (
    <main className="pt-16">
      ...
      <nav aria-label="Breadcrumb" style={{ backgroundColor: "var(--surface)", borderBottom: "1px solid var(--wire)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8 py-3">
          <ol className="flex items-center gap-2 flex-wrap" style={{ color: "var(--smoke)", fontSize: "0.8125rem" }}>
            ...
            <li aria-hidden="true" style={{ color: "var(--wire)" }}>/</li>
            <li style={{ color: "var(--chalk)" }}>GBP Optimization Lakeland</li>
          </ol>
        </div>
      </nav>
      ...
      <section style={{ backgroundColor: "var(--void)", padding: "clamp(56px, 8vw, 96px) 0 clamp(40px, 6vw, 72px)", borderBottom: "1px solid var(--wire)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8">
          ...
          >
            Google Business Profile Optimization in Lakeland
          </h1>
          <p style={{ fontSize: "1.0625rem", color: "var(--ash)", lineHeight: 1.75, maxWidth: "640px", marginBottom: "40px" }}>
            Primara builds and manages Google Business Profiles for independent medical
            practices. For a Lakeland practice, the Maps pack is where new Polk County
            residents pick a doctor — we configure and maintain your profile so it
            competes there instead of sitting invisible below the big health systems.
          </p>
        ...
        <div className="mx-auto max-w-content px-6 lg:px-8">
          <div style={{ maxWidth: "760px" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 400, color: "var(--chalk)", lineHeight: 1.2, marginBottom: "24px" }}>
              In Lakeland, the Maps pack is the front door to your practice.
            </h2>
            <p style={{ fontSize: "1rem", color: "var(--ash)", lineHeight: 1.8, marginBottom: "20px" }}>
              Lakeland sits halfway between Tampa and Orlando on the I-4 corridor, and
              Polk County keeps adding residents who need a doctor before they know a
              single practice name. Their first move is a Google search, and the map
              listings appear above everything else. Which three profiles show up there
              is decided by configuration, activity, and consistency — things the large
              health systems have staff working on, and most independent practices set
              up once and never touch again.
            </p>
            <p style={{ fontSize: "1rem", color: "var(--ash)", lineHeight: 1.8 }}>
              ...
              health, and men&rsquo;s health practices — the same disciplined GBP process
      ...
      <RelatedLinks
        ...
        items={[
          { href: "/services/google-business-profile", label: "GBP Optimization for Medical Practices", description: "The full service — profile configuration, posting cadence, and Maps-pack strategy." },
          { href: "/locations/medical-seo-lakeland", label: "Medical SEO in Lakeland", description: "The full SEO stack — GBP is one layer; this is the rest." },
      ...
      <section style={{ backgroundColor: "var(--color-primary)", borderTop: "3px solid var(--ember)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8 py-16 text-center">
          <h2 style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 400, color: "var(--chalk)", marginBottom: "1rem" }}>
            Ready to Win the Lakeland Maps Pack?
          </h2>
