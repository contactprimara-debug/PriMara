...
const PAGE_URL = `${SITE_URL}/locations/google-ads-management-lakeland`;

export const metadata: Metadata = {
  title: "Google Ads Management in Lakeland, FL | Primara",
  description:
    "Google Ads management for independent medical practices in Lakeland and Polk County — search campaigns, Local Service Ads, and HIPAA-conscious tracking from a Florida agency. Call (561) 291-2681.",
  alternates: { canonical: PAGE_URL },
  robots: { index: true, follow: true },
  openGraph: {
    title: "Google Ads Management in Lakeland, FL | Primara",
    description:
      "Google Ads management for independent medical practices in Lakeland — search campaigns, Local Service Ads, and HIPAA-conscious conversion tracking.",
    type: "website",
    url: PAGE_URL,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Google Ads Management Lakeland", item: PAGE_URL },
  ],
};
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Google Ads Management in Lakeland",
  url: PAGE_URL,
  provider: {
    "@type": "LocalBusiness",
    name: "Primara",
  ...
  description:
    "Google Ads campaign management for independent medical practices in Lakeland, Florida — search campaigns, Local Service Ads, keyword and landing-page strategy, and HIPAA-conscious conversion tracking.",
};

const faqs = [
  {
    q: "Do you manage Google Ads for practices in Lakeland?",
    a: "Yes. Primara is a Florida-based agency — headquartered in West Palm Beach — and we manage Google Ads for independent practices nationwide, including the Lakeland market. Campaign management is fully remote: we run a market analysis of your Polk County service area before a single dollar of ad spend goes live.",
  },
  {
    q: "How much does Google Ads cost for a Lakeland practice?",
...
const deliverables = [
  {
    ...
    body: "Campaigns targeting the searches Lakeland patients actually make — by condition, service, and neighborhood — with negative keywords to keep spend off searches that never convert into patients.",
  },
  {
...
export default function GoogleAdsManagementLakelandPage() {
  return (
    <main className="pt-16">
      ...
      <nav aria-label="Breadcrumb" style={{ backgroundColor: "var(--surface)", borderBottom: "1px solid var(--wire)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8 py-3">
          <ol className="flex items-center gap-2 flex-wrap" style={{ color: "var(--smoke)", fontSize: "0.8125rem" }}>
            ...
            <li aria-hidden="true" style={{ color: "var(--wire)" }}>/</li>
            <li style={{ color: "var(--chalk)" }}>Google Ads Management Lakeland</li>
          </ol>
        </div>
      </nav>
      ...
      <section style={{ backgroundColor: "var(--void)", padding: "clamp(56px, 8vw, 96px) 0 clamp(40px, 6vw, 72px)", borderBottom: "1px solid var(--wire)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8">
          ...
          >
            Google Ads Management in Lakeland
          </h1>
          <p style={{ fontSize: "1.0625rem", color: "var(--ash)", lineHeight: 1.75, maxWidth: "640px", marginBottom: "40px" }}>
            Primara manages Google Ads for independent medical practices — search
            campaigns, Local Service Ads, and HIPAA-conscious conversion tracking. For a
            Lakeland practice, paid search is the fastest way to reach the new residents
            arriving along the I-4 corridor before the big health systems do.
          </p>
        ...
        <div className="mx-auto max-w-content px-6 lg:px-8">
          <div style={{ maxWidth: "760px" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 400, color: "var(--chalk)", lineHeight: 1.2, marginBottom: "24px" }}>
              In a fast-growing market, paid search buys you time SEO can&rsquo;t.
            </h2>
            <p style={{ fontSize: "1rem", color: "var(--ash)", lineHeight: 1.8, marginBottom: "20px" }}>
              Organic SEO in Lakeland takes months to compound. Google Ads puts your
              practice at the top of the results page the week your campaigns go live —
              in front of the people moving into Polk County every month who don&rsquo;t
              yet have a doctor, a therapist, or a clinic they trust. Those patients
              search once, call whoever looks credible, and rarely scroll past the first
              few results.
            </p>
      ...
      <RelatedLinks
        ...
        items={[
          { href: "/services/google-ads", label: "Google Ads for Medical Practices", description: "The full service — campaign structure, LSAs, budgets, and HIPAA-conscious tracking." },
          { href: "/locations/medical-seo-lakeland", label: "Medical SEO in Lakeland", description: "The organic side — the full SEO stack for Lakeland practices." },
      ...
      <section style={{ backgroundColor: "var(--color-primary)", borderTop: "3px solid var(--ember)" }}>
        <div className="mx-auto max-w-content px-6 lg:px-8 py-16 text-center">
          <h2 style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 400, color: "var(--chalk)", marginBottom: "1rem" }}>
            Ready for New Patients in Lakeland?
          </h2>
